...
func TestSnapMirror(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input:            ClusterStr + "update a snapmirror relationship of destination path " + rn("dtsvm") + ":" + rn("dtvol") + " with transfer schedule name to hourly",
			expectedOntapErr: "",
			verifyAPI:        ontapVerifier{api: "api/snapmirror/relationships?destination.path=" + rn("dtsvm") + ":" + rn("dtvol") + "&fields=state,policy.name", validationFunc: verifySnapMirror(true, "Asynchronous", "uninitialized")},
		},
		{
			name:             "Update SnapMirror relationship 2",
			input:            ClusterStr + "update a snapmirror relationship of destination path " + rn("dtsvm") + ":" + rn("dtvol") + " with policy name MirrorAndVault",
			expectedOntapErr: "",
		...
		},
		{
			...
			input:            ClusterStr + "initialize a snapmirror relationship of destination path " + rn("dtsvm") + ":" + rn("dtvol"),
			expectedOntapErr: "",
		...
		},
		{
			...
			input:            ClusterStr + "break a snapmirror relationship of destination path " + rn("dtsvm") + ":" + rn("dtvol"),
			expectedOntapErr: "",
		...
		},
		{
			...
			input:            ClusterStr + "resync a snapmirror relationship of destination path " + rn("dtsvm") + ":" + rn("dtvol"),
			expectedOntapErr: "",
			verifyAPI:        ontapVerifier{api: "api/snapmirror/relationships?destination.path=" + rn("dtsvm") + ":" + rn("dtvol") + "&fields=state,policy.name", validationFunc: verifySnapMirror(true, "MirrorAndVault", "snapmirrored")},
		},
		{
			name:             "Delete SnapMirror relationship",
			input:            ClusterStr + "delete a snapmirror relationship of destination path " + rn("dtsvm") + ":" + rn("dtvol"),
			expectedOntapErr: "",

...
type OntapGetParams struct {
	...
	PathParams map[string]string `json:"path_params,omitzero" jsonschema:"values for path placeholders when the path contains {param} segments, e.g. {\"uuid\":\"abc-123\"}. Get the UUID first from the collection endpoint."`
